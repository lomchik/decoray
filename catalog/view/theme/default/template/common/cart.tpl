    ...
    <li>
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td class="text-center"><button type="button" onclick="cart.remove('<?php echo $product['cart_id']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-link btn-xs"><i class="fa fa-times"></i></button></td>
        </tr>
        <?php } ?>
